...
<script type="text/javascript" src="js/recommend_template.js"></script>
...
<body leftmargin="8" topmargin='8'>
	<table width="98%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><div style='float: left'>
					<img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用服务资源智能推荐系统，请在左侧列表中选择您要点播的服务资源:
				</div>
	...
	<table width="98%" align="center" border="0" cellpadding="4"
		...
		<tr bgcolor="#EEF4EA">
			<td colspan="2" background="skin/images/frame/wbg.gif" class='title' align="center"><span>关联资源推荐</span></td>
		</tr>
