	...
	<table width="98%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><div style='float: left'>
					<img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用服务资源智能推荐系统，系统推荐您的最热门的视频资源数据如下表所示：
				</div>
				...
				<table width="98%" align="center" border="0" cellpadding="4"
					...
					<tr bgcolor="#EEF4EA">
						<td colspan="9" background="skin/images/frame/wbg.gif"
							class='title'><span>热门资源推荐</span></td>
					</tr>
					<tr bgcolor="#FAFAF1">
					...
					<s:iterator value="#request.items" var="item" status="st"  >
						<tr bgcolor="#FFFFFF">
							...
							<td style="color:red"><s:property value="#request.counts.get(#st.index)" /></td>
						</tr>
					</s:iterator>
