						...
						<TR
							...
							<TD>
								<SPAN
									...
									style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0 px: ">分组分角色
								</SPAN><SPAN
							...
							<TD
								...
								<form name="f" action="updateGroupInfo" name="post">
                                    ...
                                    <input type="submit"  onclick="return confirm('are you sure?');" class=cmdField
										id=ctl00_ContentPlaceHolder2_GridView1_ctl02_LinkButton1 value="修改"/>
									</form>
									<form action="groupBegin" method="post">
									<input type="submit"  onclick="return confirm('are you sure?')" class=cmdField
										id=ctl00_ContentPlaceHolder2_GridView1_ctl02_LinkButton1 value="开始分组"/>
                                  </form>
								</DIV>
							</TD>
