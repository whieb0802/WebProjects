...
<%--       </select>--%>
              ...
              <TBODY>
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>区域</TH>
  ...
  <p align="right"><a href="<%=basePath %>manager/userList?page=1"> 第一页    </a> 
                                   当前第<%=pageView.getCurrentPage()<1?1:pageView.getCurrentPage()%>页    
  <a href="<%=basePath %>manager/userList?page=<%=pageView.getCurrentPage()-1%>"> 上一页   </a>
 <a href="<%=basePath %>manager/userList?page=<%=(pageView.getCurrentPage()+1)>pageView.getTotalPage()?pageView.getTotalPage():(pageView.getCurrentPage()+1)%>"> 下一页 </a>
    <a href="<%=basePath %>manager/userList?page=<%=pageView.getTotalPage()%>">最后一页</a></p>
          </DIV>
        </TD>
