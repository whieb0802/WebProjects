...
<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><img src="../images/icon04.gif" width="84" height="84"  ondblclick="createwin('查看同组信息','commonGroup?userid=<%=userid%>&currentime=<%=currentime %>&roleid=<%=roleid %>&error=3',4,heighs/2-450/2,widths/2-750/2,800,500,0,0,0)"></td>
        <td>&nbsp;</td>
...
<div id="left05" class="left01"><div align="center">零售商</div></div>
...
<div id="main04" class="left01"><img src="../images/03_1.png" width="98" height="98" onDblClick="createwin('商品入库','inventoryaction!retailerincome?current=<%=currentime%>&error=3',13,heighs/2-250/2,widths/2-550/2,400,250,0,0,0)"></div>
<div id="main05" class="left01"><img src="../images/08_1.png" width="98" height="98" onDblClick="createwin('获取订单','consumeaction!receive?currentime=<%=currentime%>&error=3',14,heighs/2-250/2,widths/2-550/2,400,250,0,0,0)"></div>
<div id="main06" class="left01"><img src="../images/04_1.png" width="98" height="98" onDblClick="createwin('商品出售','consumeaction!outcome?userid=<%=userid %>&currentime=<%=currentime%>&error=3',15,heighs/2-250/2,widths/2-550/2,400,300,0,0,0)"></div>
