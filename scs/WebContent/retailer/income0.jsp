...
function billConfirm000(){
	winOpen('inventoryaction!rbillconfirm?userid=<%=bill.getBto()%>&currentime=<%=bill.getCurrentime().getCurrentime()%>&upstream=<%=bill.getBfrom()%>','列表',450,300);
}
</script>
</head>
<body>
...
元</td>
          ...
          <table width="244" border="0" align="center">
            <tr>
              ...
              <td width="67"><input type="button" onclick="billConfrim000()" value="确定" /></td>
            </tr>
          </table>
