...
<body>
  ...
  %>
     <tr>
       ...
       <td align="center" bgcolor="#99FFCC"><s:if test="i>=0">未发货</s:if><s:else>dd</s:else></td>
       <td align="center" bgcolor="#99FFCC"></td>
     </tr>
<%--     <tr>--%>
<%--       <td align="center" bgcolor="#99FFCC"><%=orders.get(i).getCurrentime().getCurrentime()%></td>--%>
<%--       <td align="center" bgcolor="#99FFCC">P2</td>--%>
<%--       <td align="center" bgcolor="#99FFCC"><%=orders.get(i).getOto() %></td>--%>
<%--       <td align="center" bgcolor="#99FFCC"><%=orders.get(i).getCountp1()%></td>--%>
<%--       <td align="center" bgcolor="#99FFCC"><%=orders.get(i).getP1price() %></td>--%>
<%--       <td align="center" bgcolor="#99FFCC"><s:if test="#request.bills.get(i) == null">未发货</s:if>--%>
<%--       <s:if test="#request.bills.get(i) != null"><%=bills.get(i).getCountp1() %></s:if></td>--%>
<%--       <td align="center" bgcolor="#99FFCC"><s:if test="#request.bills.get(i) == null">未发货</s:if>--%>
<%--       <s:if test="#request.bills.get(i) != null"><%=bills.get(i).getReceivetime() %></s:if></td>--%>
<%--     </tr>--%>
<%--     <tr>--%>
<%--       <td align="center" bgcolor="#99FFCC"><%=orders.get(i).getCurrentime().getCurrentime()%></td>--%>
