...
<link href="../css/mlayers.css" rel="stylesheet" type="text/css">
</head>
...
<div id="left05" class="left01"><div align="center">生产商</div></div>
...
<div id="main03" class="left01"><img src="../images/09_1.png" width="98" height="98" onDblClick="createwin('厂房租买','manufactureraction!factoryinfo?roleid=<%=roleid%>&current=<%=currentime %>&error=3',12,heighs/2-250/2,widths/2-550/2,500,400,0,0,0)"></div>
<div id="main04" class="left01"><img src="../images/11_1.png" width="98" height="98" onDblClick="createwin('生产线租买','newGrowline.jsp?currentime=<%=currentime%>&error=3',12,heighs/2-250/2,widths/2-550/2,500,320,0,0,0)"></div>
<div id="main05" class="left01"><img src="../images/03_1.png" width="98" height="98" onDblClick="createwin('商品入库','inventoryaction!retailerincome?current=<%=currentime%>&userid=<%=userid%>&roleid=<%=roleid%>&up=<%=upstream%>&error=zkz',13,heighs/2-250/2,widths/2-550/2,400,250,0,0,0)"></div>
<div id="main06" class="left01"><img src="../images/10_1.png" width="98" height="98" onDblClick="createwin('下一批生产','growlineaction!large?current=<%=currentime%>&userid=<%=userid %>&error=3',16,heighs/2-250/2,widths/2-550/2,630,250,0,0,0)"></div>
<div id="main07" class="left01"><img src="../images/04_1.png" width="98" height="98" onDblClick="createwin('商品出售','agentaction!outcome?current=<%=currentime%>&userid=<%=userid %>&error=3',15,heighs/2-250/2,widths/2-550/2,800,550,0,0,0)"></div>
<div id="main08" class="left01"><img src="../images/05_1.png" width="98" height="98" onDblClick="createwin('更新应收款','agentaction!addfund?current=<%=currentime%>&userid=<%=userid%>&roleid=<%=roleid%>&error=3',14,heighs/2-250/2,widths/2-550/2,400,250,0,0,0)"></div>
<div id="main10" class="left01"><img src="../images/07_1.png" width="98" height="98" onDblClick="bzjsConfirm()" ></div>
