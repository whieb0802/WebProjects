	...
	<body onLoad="onload();">
		...
		<div class="container">
			...
			<div id="header">
				...
				<div id="actor">
					<p><span class="STYLE2" style="cursor: hand">角色：代理商</span></p>
...
<div class="boxBody">
  ...
  <div class="show">
    <ul>
	   <li class="STYLE4">
	     <input type="submit"  onClick="bzksConfirm()" value="本周开始"/>
	     </li>
       <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;&darr;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&darr;</font></li>
       <li class="STYLE4"><input type="button" onClick="javaScript:winOpen('newLoan.jsp?currentime=<%=currentime%>&totaloan=<%=fund.getTotaloan() %>','列表',450,200)" value="申请贷款"/></li> 
       <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;↓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</font></li>
	   <li class="STYLE4"><input name="button" type="button" onClick="javaScript:winOpen('storage.jsp?currentime=<%=currentime%>','列表',450,200)" value="仓库租买"/>
	   </li>
	   <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;↓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</font></li>
	   <li class="STYLE4"><input name="button2" type="button" onClick="javaScript:winOpen('inventoryaction!retailerincome?current=<%=currentime%>&userid=<%=userid%>&roleid=<%=roleid%>&upstream=<%=upstream%>','列表',450,200)" value="商品入库"/></li>
	   <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;↓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</font></li>
	   <li class="STYLE4"><input type="button" onClick="javaScript:winOpen('agentaction!outcome?current=<%=currentime%>&userid=<%=userid %>','列表',700,500)" value="商品出售"/>
	   </li>
       <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;↓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</font></li>
	   <li class="STYLE4">
	     <input name="button5" type="button" onClick="javaScript:winOpen('agentaction!addfund?current=<%=currentime%>&userid=<%=userid%>&roleid=<%=roleid%>','列表',450,200)" value="更新应收款"/>
	     </li>
       <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;&darr;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&darr;</font></li>
       <li class="STYLE4"><input type="button" onClick="javaScript:winOpen('newOrder.jsp?currentime=<%=currentime%>&upstream=<%=upstream%>','列表',450,300)" value="发出订单"/></li>
       <li class="STYLE4"><font>&nbsp;&nbsp;&nbsp;&nbsp;↓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</font></li>
...
<div class="boxBottom"></div> 
	...
	<div id="Layer1">
	  <ul class="topnav2">
	    ...
	    <p>
	    <input type="button" onClick="javaScript:winOpen('orderaction!selectOrder?userid=<%=userid%>&roleid=<%=roleid%>&current=<%=currentime %>&upstream=<%=upstream %>','列表',700,600)" value="查看订单信息"/>
	</p>
	    <p>
       ...
       <p>
          <input type="button" onClick="javaScript:winOpen('storageaction!info?userid=<%=userid%>&currentime=<%=currentime %>','列表',450,300)" value="查看仓库信息"/>
	    </p>
	    <p>    
	    ...
	    <p>
          <input name="button4" type="button" onClick="javaScript:winOpen('neworder!selectOrder','列表',450,300)" value="市场预测"/>
	  </p>
	    <p>
          <input name="button4" type="button" onClick="javaScript:winOpen('neworder!selectOrder','列表',450,300)" value="同组情况"/>
	  </p>
          <s:debug/>
      </ul>
	</div>
