...
<body>
 ...
 %>
 <s:if test="#request.orders.get(#request.i).currentime.currentime == #request.bills.get(#request.i).currentime.currentime-1
           &&#request.orders.get(#request.i).oto == #request.bills.get(#request.i).bfrom
           &&#request.orders.get(#request.i).ofrom == #request.bills.get(#request.i).bto">
<%--  <% continue;%>--%>
